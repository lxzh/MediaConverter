...
JNIEXPORT jint JNICALL Java_com_yuelt_ffmpeg_tool_VideoPlayer_play
...
//设置播放速率
JNIEXPORT jint JNICALL Java_com_yuelt_ffmpeg_tool_VideoPlayer_setPlayRate
        (JNIEnv * env, jclass clazz, jfloat playRate){
        play_rate = playRate;
}

//获取视频总时长
JNIEXPORT jint JNICALL Java_com_yuelt_ffmpeg_tool_VideoPlayer_getDuration
