...
JNIEXPORT jint JNICALL Java_com_yuelt_ffmpeg_tool_MediaPlayer_setup
...
JNIEXPORT jint JNICALL Java_com_yuelt_ffmpeg_tool_MediaPlayer_play
...
JNIEXPORT void JNICALL Java_com_yuelt_ffmpeg_tool_MediaPlayer_release
        (JNIEnv * env, jclass clazz){
    //释放内存以及关闭文件
