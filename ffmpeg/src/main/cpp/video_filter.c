...
JNIEXPORT jint JNICALL Java_com_yuelt_ffmpeg_tool_VideoPlayer_filter
...
JNIEXPORT void JNICALL Java_com_yuelt_ffmpeg_tool_VideoPlayer_again(JNIEnv * env, jclass clazz) {
    again = 1;
}

JNIEXPORT void JNICALL Java_com_yuelt_ffmpeg_tool_VideoPlayer_release(JNIEnv * env, jclass clazz) {
    release = 1;
}

JNIEXPORT void JNICALL Java_com_yuelt_ffmpeg_tool_VideoPlayer_playAudio(JNIEnv * env, jclass clazz, jboolean play_audio) {
