...
import com.yuelt.ffmpeg.format.VideoLayout;
...
public class FFmpegUtil {
     ...
     * @return 音量放大后的文件
     */
    public static String[] amplifyAudio(String srcFile, String targetFile){
        String transformAudioCmd = "ffmpeg -i %s -af volume=5 %s";
        transformAudioCmd = String.format(transformAudioCmd, srcFile, targetFile);
        return transformAudioCmd.split(" ");//以空格分割为字符串数组
    }
